...
- Use `help evdaa` or `help <any-evdaa-function>` in MATLAB to show the usage of the functions of the framework.

## License
Copyright (c) 2016, Antonio Coratelli.
Released under BSD 3-Clause License. See 'LICENSE' file.

> This software includes [GLPKMEX][4] binaries. GLPKMEX is a MATLAB MEX interface for the [GLPK][5] library which is a set of routines intended for solving linear programming (LP), mixed integer programming (MIP), and other related problems. GLPKMEX and GLPK are released under GPLv2 License, thus a copy of source code and license of GLPKMEX is provided in `glpkmex-2.11-src.zip`.
